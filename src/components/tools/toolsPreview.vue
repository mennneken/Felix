...
export default {
  computed: {
    styleParagraphe() {
      return {
        ...
        marginTop:
          this.textSpace.before.value.toString() + this.textSpace.before.unit,
        marginBottom:
          this.textSpace.after.value.toString() + this.textSpace.after.unit
      };
    },
    ...
    styleTitle() {
      return {
        ...
        marginTop:
          this.titleSpace.before.value.toString() + this.titleSpace.before.unit,
        marginBottom:
          this.titleSpace.after.value.toString() + this.titleSpace.after.unit
      };
    },
  ...
  methods: {
    fontSizeLevel(level) {
      return (
        this.fontSize.base.value * this.fontSize.ratio ** level +
